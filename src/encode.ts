...
import { HuffmanEncoderKey, InvalidEncoderKeyError } from "./types.js";
 ...
 */
export function* encodeToBytes<T>(string: Iterable<T>, key: HuffmanEncoderKey<T>): Generator<{ byte: number, leftoverBits: number }, void, never> {
